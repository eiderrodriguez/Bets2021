...
public class AdminPantaila extends JFrame {
	...
	private JButton btnGalderaSortu = new JButton(ResourceBundle.getBundle("Etiquetas").getString("CreateQuestion"));
	private JButton btnKuotaSortu = new JButton(ResourceBundle.getBundle("Etiquetas").getString("CreateFee"));
	private JButton gertaeraSortu = new JButton(ResourceBundle.getBundle("Etiquetas").getString("CreateEvent"));
	private JButton btnErantzun = new JButton(ResourceBundle.getBundle("Etiquetas").getString("CreateAnswer"));
	private JButton  btnGertaeraKantzelatu = new JButton(ResourceBundle.getBundle("Etiquetas").getString("CancelEvent"));
	private JButton gehienIrabazi = new JButton(ResourceBundle.getBundle("Etiquetas").getString("MostEarning"));
